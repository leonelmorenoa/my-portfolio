  ...
  return (
    <div>
      <p className="text-[12px] xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-soft-dark">
        I&apos;m currently open to full-time roles, collaborations, and data-driven projects.
        If you&apos;d like to discuss an opportunity, feel free to reach out.
      </p>

      <div className="mx-2">
        <form
          className="flex flex-col gap-4 mt-4"
          action="https://formspree.io/f/xzzwndzl"
          method="POST"
        >
          <input
            type="text"
