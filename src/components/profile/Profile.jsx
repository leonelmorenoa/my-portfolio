    ...
    >
      <div className="flex max-md:flex-col justify-between items-center gap-6">
        ...
        <div className="max-sm:w-full w-[33rem]">
          ...
          >
            <p className={``}>
            I design <span className="bg-[#1E96FC33] text-[#000080] px-2 py-0.5 rounded-lg">business solutions</span> that save you time, cut costs, and generate revenue. Using data to accelerate growth of your company.
            </p>
            <p className="mt-3">
