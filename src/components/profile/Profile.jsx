    ...
    >
      <div className="flex max-md:flex-col justify-between items-center gap-6">
        ...
        <div className="max-sm:w-full w-[33rem]">
          ...
          >
            <p className={``}>
            Data Systems: Built by an <span className="bg-[#1E96FC33] text-[#000080] px-2 py-0.5 rounded-lg"> Economist</span>. Measured in business results. Make data profitable.
            </p>
            <p className="mt-3">
