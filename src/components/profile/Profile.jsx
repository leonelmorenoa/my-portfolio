    ...
    >
      <div className="flex max-md:flex-col justify-between items-center gap-6">
        ...
        <div className="max-sm:w-full w-[33rem]">
          ...
          >
            <p className={``}>
              With a background in <span className="bg-[#1E96FC33] text-[#000080] px-2 py-0.5 rounded-lg"> Economics</span> (Carabobo University) and specialized training in analytics, I build data systems that drive measurable business impact.
            </p>
            <p className="mt-3">
            ...
            <p className="mt-3">
             In addition, I have served as an instructor for data analysis workshops, <span className="bg-[#1E96FC33] text-[#000080] px-2 py-0.5 rounded-lg">spoken at data conferences</span> , and as consultant.
            </p>
          </div>
